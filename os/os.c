...
* Attention		 : None
*******************************************************************************/
void OS_CreatTask(unsigned char ID, void (*proc)(void), 
...
void F_QueueEmpty(float **Head, float **Tail, float *HBuff)
{
		*Head = HBuff;
		*Tail = HBuff;
}
...
void F_QueueDataIn(float **Head, float **Tail, float *HBuff, unsigned short Len, float *HData, unsigned short DataLen)
{	
	float num;
	unsigned char IptStatus;
	Len = Len/4;
...
unsigned char F_QueueDataOut(float **Head, float **Tail, float *HBuff, unsigned short Len, float *Data)
{					   
	unsigned char back = 0;
	unsigned char IptStatus;
    Len = Len/4;
...
unsigned short F_QueueDataLen(float **Head, float **Tail, unsigned short Len)
{
		if(*Tail > *Head)
			return *Tail-*Head;
		if(*Tail < *Head)
